...
| :--- | :--- | :--- | :--- | :--- | :--- |
| OpenAI (Chat Completions) | OpenAI | Text/Chat LLM | General-purpose conversation, Q&A, reasoning | [Docs](https://platform.openai.com/docs/api-reference/chat) | [OpenAI.json]([https://github.com/Ronakkadhi/awesome-ai-apis/blob/main/OpenAI.json](https://raw.githubusercontent.com/Ronakkadhi/awesome-ai-apis/main/OpenAI.json)) |
